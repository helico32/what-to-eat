...
function UserIcon()      { return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg> }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-body font-semibold text-[16px] uppercase tracking-wider text-ink-primary px-5 mb-3">
          Outils
        </p>
        ...
        {!authLoading && (
          <>
            ...
            <div className="px-3">
              ...
              {/* Connectée — ouvre la page Mon compte */}
              {!isAnonymous && (
                <button
              ...
              {/* Anonyme — ouvre la page de choix de plan */}
              {isAnonymous && (
                <button
