            ...
            <div className="flex-1 px-4 pt-5 pb-10">
              ...
              <div className="mb-8">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-canvas-surface border border-canvas-border rounded-xl font-body text-[14px] outline-none focus:border-forest transition-colors"
                />
              </div>
